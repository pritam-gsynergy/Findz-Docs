...
You can use Findz to collect links, products, files, places, etc and invite your friends and family to join you on groups, only after you have created an account on the mobile app. Findz is available both for **iOS and Android** on mobile and for Chrome and Safari as **browser extensions.** Learn how you can  **[download and intall the Findz extension](../findz-browser-extension/install-the-findz-browser-extension.md)**  

You must have an active Findz account use the app and it's features. Let's learn more about how you can **create an account** on Findz.
